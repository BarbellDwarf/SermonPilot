...
class ProcessingModeSelector:
    ...
    def __init__(self):
        ...
        self.modes = {
            'standard': {
                ...
                'use_cases': [
                    'Standard sermons', 'Single speaker presentations', 'Music with speech',
                ]
            },
            'question_friendly': {
            ...
            'gentle_enhancement': {
                ...
                'use_cases': [
                    'High-quality recordings', 'Professional productions', 'Studio recordings',
                ]
            },
            'aggressive_cleanup': {
                ...
                'use_cases': [
                    'Noisy environments', 'Poor quality recordings', 'Background noise issues',
                ]
            },
            'custom': {
    ...
    def _render_mode_cards(self) -> str | None:
    ...
    def _render_fine_tuning_controls(self, base_settings: dict[str, Any]) -> dict[str, Any]:
        ...
        if (
            base_settings.get('preserve_questions')
            and st.checkbox("Adjust Question Processing", key="adjust_q")
        ):
            settings['question_amplification_db'] = st.slider(
                "Question Amplification (dB)",
    ...
    def get_processing_config(self, settings: dict[str, Any]) -> dict[str, Any]:
        ...
        config = {
            ...
            'gentle_noise_reduction': (
                settings.get('noise_reduction_strength', 0.5) * 0.5
            ),  # Half strength for gentle areas
    ...
    def load_custom_preset(self, name: str) -> dict[str, Any] | None:
        """
