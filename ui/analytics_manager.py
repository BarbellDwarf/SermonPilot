...
class AnalyticsManager:
    ...
    async def get_sermon_analytics(self, sermon_id: str) -> SermonAnalytics | None:
    ...
    async def _fetch_sermon_analytics(self, sermon_id: str) -> SermonAnalytics | None:
    ...
    def _get_fallback_sermon_analytics(self, sermon_id: str) -> SermonAnalytics | None:
    ...
    def invalidate_cache(self, sermon_id: str | None = None):
...
def get_analytics_manager(config: dict[str, Any] | None = None) -> AnalyticsManager:
