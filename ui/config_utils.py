...
BUILTIN_PROMPT_TEMPLATES: dict[str, Any] = {
    ...
    "description": {
        ...
        "user": (
            ...
            "Transcript:\n{transcript}\n\nGuidelines:\n"
            "- One paragraph of plain prose: cover the main message, the key scripture, "
            "and the practical application\n"
            "- Four to six sentences is usually enough; keep it under 1400 characters "
            "so the upload is accepted\n"
            "{speaker_instruction}"
