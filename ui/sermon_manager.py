...
class SermonManager:
    ...
    async def get_sermon_list(self, filters: dict[str, Any] | None = None) -> list[SermonData]:
    ...
    async def get_sermon_details(self, sermon_id: str) -> SermonDetails | None:
    ...
    async def _fetch_remote_sermons(self, filters: dict[str, Any] | None = None) -> list[dict]:
    ...
    async def _fetch_remote_sermon_details(self, sermon_id: str) -> dict | None:
    ...
    def _get_local_sermon_data(self, sermon_id: str) -> dict | None:
...
def get_sermon_manager(config: dict[str, Any] | None = None) -> SermonManager:
