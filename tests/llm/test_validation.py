...
def test_validation():
    ...
    config = {
        'llm': {
            'primary': {
                'provider': 'ollama',
                'ollama': {
                    'host': 'http://REDACTED-INTERNAL-IP:11434',
                    'model': 'phi3:14b'
                }
            },
            'fallback': {
    ...
    good_description = """
    Sample Speaker teaches from Romans 8:28 about God's sovereignty in all circumstances. 
    He explains how believers can trust that God works all things together for good 
    for those who love Him and are called according to His purpose. the speaker emphasizes 
