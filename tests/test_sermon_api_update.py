...
def main():
	...
	title = "Zechariah - Sample Speaker"
	speaker = "Sample Speaker"
	description = "Expository sermon on Zechariah. Covers prophecy and relevance for today."
	hashtags = ["zechariah", "prophecy", "old testament", "mark speaker"]
	audio_path = "tests/2024-12-12 - Zechariah - Sample Speaker (1212241923147168).mp3"
