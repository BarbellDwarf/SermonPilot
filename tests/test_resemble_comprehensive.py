...
Tests the enhanced audio processing pipeline with the Sample Speaker sermon
"""
...
def test_resemble_enhance_on_real_sermon():
    """Test Resemble Enhance processing on the Sample Speaker sermon"""
    ...
    audio_file = test_dir / "2024-12-12 - Zechariah - Sample Speaker (1212241923147168).mp3"
