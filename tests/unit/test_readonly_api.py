...
def test_sermon_detail_publication_fields(client: TestClient, fixture_db: str) -> None:
    conn = sqlite3.connect(fixture_db)
    conn.execute(
        "INSERT INTO upload_info (sermon_id, sermonaudio_id, upload_date, upload_status)"
        " VALUES (?, ?, ?, ?)",
