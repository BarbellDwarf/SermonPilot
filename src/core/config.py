...
ENV_CONFIG_MAP: dict[str, list[list[str]]] = {
    ...
    'ANTHROPIC_API_KEY': [
        ...
        ['llm', 'fallback', 'anthropic', 'api_key'],
        ['llm', 'validator', 'anthropic', 'api_key'],
    ],
    'XAI_API_KEY': [
        ['llm', 'primary', 'xai', 'api_key'],
        ['llm', 'fallback', 'xai', 'api_key'],
    ],
    'GOOGLE_API_KEY': [
        ['llm', 'primary', 'google', 'api_key'],
        ['llm', 'fallback', 'google', 'api_key'],
        ['llm', 'validator', 'google', 'api_key'],
    ],
    'GROQ_API_KEY': [
        ['llm', 'primary', 'groq', 'api_key'],
        ['llm', 'fallback', 'groq', 'api_key'],
        ['llm', 'validator', 'groq', 'api_key'],
    ],
    'OLLAMA_HOST': [
    ...
    'WHISPER_OPENAI_API_KEY': [['transcription', 'whisper_openai', 'api_key']],
    'WHISPER_OPENAI_BASE_URL': [['transcription', 'whisper_openai', 'base_url']],
    'WHISPER_OPENAI_MODEL': [['transcription', 'whisper_openai', 'model']],
