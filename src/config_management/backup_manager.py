...
class ConfigBackupManager:
    ...
    def restore_backup(self, backup_file: Path, confirm: bool = False):
        ...
        restoration_point = self.create_backup(
        ...
        try:
            ...
            raise Exception(
                ...
                f"Restoration point saved at: {restoration_point}"
            ) from e
    ...
    def _restore_data(self, backup_data: dict[str, Any]):
        ...
        try:
            ...
            restore_order = [
                'configuration_categories', 'configuration_keys', 'configuration_values',
                'configuration_history', 'configuration_exports',
            ]
            ...
            if 'configuration_categories' in data and 'configuration_keys' in data:
                ...
                if orphaned_keys:
                    verification_result['warnings'].append(
                        f"Found {len(orphaned_keys)} orphaned keys"
                    )
